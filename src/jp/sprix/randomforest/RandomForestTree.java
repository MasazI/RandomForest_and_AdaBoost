...
public class RandomForestTree {
	...
	private RandomForestSampleCase allSampleCase = null;
	 ...
	 *            全事例
	 */
	public RandomForestTree(int treeNum, int[] samplingNum, RandomForestSampleCase allSampleCase) {
	...
	public void makeTree() {
		...
		// ファイル出力
		Output.outputFile(prop.getProperty("randomforest.dictionary.dir") + treeNum + ".tsv", sb);
	}
	...
	private String[] getNodeTypeCandidate() {
		// サンプリング個数
		int nodeTypeCnt = Math.round(Math.round(Math.sqrt(NodeType.nodeTypes.length))) + 1;
	 ...
	 * @param allSampleCase
	 */
	public int[] validation(RandomForestSampleCase allSampleCase) {
